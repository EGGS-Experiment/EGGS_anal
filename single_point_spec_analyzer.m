...
%Use this code for when you run Ion Spectrum Analyzer with a single
%frequency value for each sideband, multiple ecular frequencies, and the detuning 0 
%figure;plot(data(:,2))
